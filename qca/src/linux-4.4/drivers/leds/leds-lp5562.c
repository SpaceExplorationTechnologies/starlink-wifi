...
#define LP5562_RUN_SRAM_SETTING 0x60
...
static int lp5562_post_init_device(struct lp55xx_chip *chip)
{
	...
	//test blue led
	/*lp55xx_write(chip, LP5562_REG_ENG_SEL, 0x00);
	msleep(10);
	lp55xx_write(chip, LP5562_REG_B_PWM, 0x10);*/
	
	
	//test easing pattern
	//printk("6666666666set 299  close kernel led close probe reset");
	/*lp55xx_write(chip, LP5562_REG_ENABLE, LP5562_MASTER_ENABLE);
	msleep(10);
	lp55xx_write(chip, 0x08, 0x02);
	msleep(10);
	lp55xx_write(chip, LP5562_REG_OP_MODE, LP5562_LOAD_ENG1);
	msleep(10);
	lp55xx_write(chip, LP5562_REG_ENG_SEL, LP5562_ENG1_FOR_W);
	msleep(10);
	lp55xx_write(chip, 0x10, 0x13);
	msleep(10);
	lp55xx_write(chip, 0x11, 0x7f);
	msleep(10);
	lp55xx_write(chip, 0x12, 0x4d);
	msleep(10);
	lp55xx_write(chip, 0x13, 0x00);
	msleep(10);
	lp55xx_write(chip, 0x14, 0x13);
	msleep(10);
	lp55xx_write(chip, 0x15, 0xff);
	msleep(10);
	lp55xx_write(chip, 0x16, 0x60);
	msleep(10);
	lp55xx_write(chip, 0x17, 0x00);
	msleep(10);
	lp55xx_write(chip, LP5562_REG_OP_MODE, LP5562_RUN_ENG1);
	msleep(100);
	lp55xx_write(chip, LP5562_REG_ENABLE, LP5562_RUN_SRAM_SETTING);*/
			...
			const struct i2c_device_id *id)
{
	...
	//printk("33333333333333333333333333333333close 589 is ok test close 430 close 633~635 close 593~597");
	/*lp55xx_write(chip, LP5562_REG_ENABLE, LP5562_MASTER_ENABLE);
	msleep(100);
	lp55xx_write(chip, LP5562_REG_OP_MODE, LP5562_LOAD_ENG1);
	msleep(100);
	lp55xx_write(chip, LP5562_REdG_ENG_SEL, LP5562_ENG1_FOR_W);
	msleep(100);
	lp55xx_write(chip, 0x10, 0x13);
	msleep(100);
	lp55xx_write(chip, 0x11, 0x7f);
