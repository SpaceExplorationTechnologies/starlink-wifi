...
/* Change in PKG_ID for QCN550x */
#define is_drqfn()  (!(ath_reg_rd(RST_REVISION_ID_ADDRESS) & 0x2000))


#define RST_BOOTSTRAP_DDR_WIDTH_GET(x)                               0  //0: DDR WIDTH 16, Dragonfly only support 16bit

#if 1 //This define is not exist in 550x, keep it just for pci common code. Need to modify
...
#define ATH_SPI_CMD_SECTOR_ERASE_4B_ADDR	0xdc
#define ATH_SPI_CMD_PAGE_PROG_4B_ADDR	0x12
#define ATH_SPI_CMD_READ_4B_ADDR	0x13
...
#elif (CFG_PLL_FREQ == CFG_PLL_800_675_266) //DDR2 CAL = 5
...
#define DDR_PLL_CONFIG1_NINT_VAL            DDR_PLL_CONFIG1_NINT_SET(0x1b)
#define DDR_PLL_CONFIG_REF_DIV_VAL          DDR_PLL_CONFIG_REFDIV_SET(0x1)
#define DDR_PLL_CONFIG_RANGE_VAL            DDR_PLL_CONFIG_RANGE_SET(0)
#define DDR_PLL_CONFIG_OUT_DIV_VAL1         DDR_PLL_CONFIG_OUTDIV_SET(0)
#define DDR_PLL_CONFIG_OUT_DIV_VAL2         DDR_PLL_CONFIG_OUTDIV_SET(0)
