...
#define SYN_PAL_0_PAL_COMP_CAL_DELAY_RESET                                     0x1
...
#define SYN_PAL_0_RESERVED_0_LSB                                               0
#define SYN_PAL_0_RESERVED_0_MSB                                               0
#define SYN_PAL_0_RESERVED_0_MASK                                              0x1
#define SYN_PAL_0_RESERVED_0_GET(x)                                            (((x) & SYN_PAL_0_RESERVED_0_MASK) >> SYN_PAL_0_RESERVED_0_LSB)
#define SYN_PAL_0_RESERVED_0_SET(x)                                            (((0 | (x)) << SYN_PAL_0_RESERVED_0_LSB) & SYN_PAL_0_RESERVED_0_MASK)
#define SYN_PAL_0_RESERVED_0_RESET                                             0x0
#define SYN_PAL_0_ADDRESS                                                      (0x10 + __SYN_1_REG_CSR_BASE_ADDRESS)
#define SYN_PAL_0_RSTMASK                                                      0xffffffff
#define SYN_PAL_0_RESET                                                        0x5202006
