...
ring0_more_count
			...
			Indicates the number of more buffers associated with RX
			DMA ring 0.  Field is filled in by the RX_DMA.

ring1_more_count
			
			Indicates the number of more buffers associated with RX
			DMA ring 1. Field is filled in by the RX_DMA.

ring2_more_count
			
			Indicates the number of more buffers associated with RX
			DMA ring 2. Field is filled in by the RX_DMA.

ring3_more_count
			
			Indicates the number of more buffers associated with RX
			DMA ring 3. Field is filled in by the RX_DMA.
*/
