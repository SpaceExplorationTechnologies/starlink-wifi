...
#define SOC_CORE_CLK_CTRL_DIV_MSB                                              1
#define SOC_CORE_CLK_CTRL_DIV_MASK                                             0x3
...
#define SOC_CORE_CLK_CTRL_DIV_RESET                                            0x1
#define SOC_CORE_CLK_CTRL_ADDRESS                                              (0x110 + __RTC_SOC_REG_BASE_ADDRESS)
#define SOC_CORE_CLK_CTRL_RSTMASK                                              0x3
#define SOC_CORE_CLK_CTRL_RESET                                                0x1
