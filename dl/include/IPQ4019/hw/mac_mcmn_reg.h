...
// 0x234 (MCMN_MAC_IDLE)
#define MCMN_MAC_IDLE_TRC_LSB                                                  15
#define MCMN_MAC_IDLE_TRC_MSB                                                  15
#define MCMN_MAC_IDLE_TRC_MASK                                                 0x8000
#define MCMN_MAC_IDLE_TRC_GET(x)                                               (((x) & MCMN_MAC_IDLE_TRC_MASK) >> MCMN_MAC_IDLE_TRC_LSB)
#define MCMN_MAC_IDLE_TRC_SET(x)                                               (((0 | (x)) << MCMN_MAC_IDLE_TRC_LSB) & MCMN_MAC_IDLE_TRC_MASK)
#define MCMN_MAC_IDLE_TRC_RESET                                                0x1
...
#define MCMN_MAC_IDLE_RSTMASK                                                  0xffff
#define MCMN_MAC_IDLE_RESET                                                    0xffff
