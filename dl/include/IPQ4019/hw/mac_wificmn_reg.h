...
// 0x80 (WIFICMN_CPU_CNTL)
#define WIFICMN_CPU_CNTL_REQ_PRIORITY_LSB                                      0
#define WIFICMN_CPU_CNTL_REQ_PRIORITY_MSB                                      1
#define WIFICMN_CPU_CNTL_REQ_PRIORITY_MASK                                     0x3
#define WIFICMN_CPU_CNTL_REQ_PRIORITY_GET(x)                                   (((x) & WIFICMN_CPU_CNTL_REQ_PRIORITY_MASK) >> WIFICMN_CPU_CNTL_REQ_PRIORITY_LSB)
#define WIFICMN_CPU_CNTL_REQ_PRIORITY_SET(x)                                   (((0 | (x)) << WIFICMN_CPU_CNTL_REQ_PRIORITY_LSB) & WIFICMN_CPU_CNTL_REQ_PRIORITY_MASK)
#define WIFICMN_CPU_CNTL_REQ_PRIORITY_RESET                                    0x2
#define WIFICMN_CPU_CNTL_ADDRESS                                               (0x80 + __MAC_WIFICMN_REG_BASE_ADDRESS)
#define WIFICMN_CPU_CNTL_RSTMASK                                               0x3
#define WIFICMN_CPU_CNTL_RESET                                                 0x2
