...
#define CLOCK_CONTROL_RTC_CLK_AMBA_MSB SOC_CLOCK_CONTROL_RTC_CLK_AMBA_MSB
#define CLOCK_CONTROL_RTC_CLK_AMBA_LSB SOC_CLOCK_CONTROL_RTC_CLK_AMBA_LSB
#define CLOCK_CONTROL_RTC_CLK_AMBA_MASK SOC_CLOCK_CONTROL_RTC_CLK_AMBA_MASK
#define CLOCK_CONTROL_RTC_CLK_AMBA_GET(x) SOC_CLOCK_CONTROL_RTC_CLK_AMBA_GET(x)
#define CLOCK_CONTROL_RTC_CLK_AMBA_SET(x) SOC_CLOCK_CONTROL_RTC_CLK_AMBA_SET(x)
#define CLOCK_CONTROL_SDIO2_CLOCK_MSB SOC_CLOCK_CONTROL_SDIO2_CLOCK_MSB
#define CLOCK_CONTROL_SDIO2_CLOCK_LSB SOC_CLOCK_CONTROL_SDIO2_CLOCK_LSB
#define CLOCK_CONTROL_SDIO2_CLOCK_MASK SOC_CLOCK_CONTROL_SDIO2_CLOCK_MASK
#define CLOCK_CONTROL_SDIO2_CLOCK_GET(x) SOC_CLOCK_CONTROL_SDIO2_CLOCK_GET(x)
#define CLOCK_CONTROL_SDIO2_CLOCK_SET(x) SOC_CLOCK_CONTROL_SDIO2_CLOCK_SET(x)
#define CLOCK_CONTROL_MMAC_CLOCK_MSB SOC_CLOCK_CONTROL_MMAC_CLOCK_MSB
#define CLOCK_CONTROL_MMAC_CLOCK_LSB SOC_CLOCK_CONTROL_MMAC_CLOCK_LSB
#define CLOCK_CONTROL_MMAC_CLOCK_MASK SOC_CLOCK_CONTROL_MMAC_CLOCK_MASK
#define CLOCK_CONTROL_MMAC_CLOCK_GET(x) SOC_CLOCK_CONTROL_MMAC_CLOCK_GET(x)
#define CLOCK_CONTROL_MMAC_CLOCK_SET(x) SOC_CLOCK_CONTROL_MMAC_CLOCK_SET(x)
