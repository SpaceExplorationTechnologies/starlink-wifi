...
//	6	cbf_nc_index[2:0], cbf_nc_index_mask[3], cbf_nr_index[6:4], cbf_nr_index_mask[7], cbf_bw[9:8], cbf_bw_mask[10], cbf_feedback_type[11], cbf_feedback_type_mask[12], cbf_sounding_token[18:13], cbf_sounding_token_mask[19], txbf_per_packet_no_csd_no_walsh[20], ignore_tbtt[21], m_frame_enable[22], reserved_6[31:23]
//	7	fes_time_160mhz[15:0], reserved_7[31:16]
//
// ################ END SUMMARY #################

#define NUM_OF_DWORDS_TX_FES_SETUP 8
...
struct tx_fes_setup {
    ...
    volatile uint32_t cbf_nc_index                    :  3, //[2:0]
                      ...
                      m_frame_enable                  :  1, //[22]
                      reserved_6                      :  9; //[31:23]
    volatile uint32_t fes_time_160mhz                 : 16, //[15:0]
                      reserved_7                      : 16; //[31:16]
};
...
fes_time_20mhz
			...
			Fes_time_40MHz or Fes_time_80Mhz fields or Fes_time_160Mhz.
...
fes_time_40mhz
			...
			If this bandwidth is not supported, SW should program
			the value in this field equal to the smallest of valid
			Fes_time_20MHz or Fes_time_80Mhz fields or Fes_time_160Mhz.
...
fes_time_80mhz
			...
			If this bandwidth is not supported, SW should program
			the value in this field equal to the smallest of valid
			Fes_time_20MHz or Fes_time_40Mhz fields or Fes_time_160Mhz.
...
m_frame_enable
			...
			If set, TXPCU will send mframe to phy and expect an ack
			.
...
fes_time_160mhz
			...
			The amount of time (in us)  the SW defined frame
			exchange sequence takes when transmission BW is 160 Mhz.
			
			
			
			If this bandwidth is not supported, SW should program
			the value in this field equal to the smallest of valid
			Fes_time_20MHz or Fes_time_40Mhz fields or Fes_time_80Mhz.
...
/* Description		TX_FES_SETUP_6_M_FRAME_ENABLE
			...
			<legal all>
*/
#define TX_FES_SETUP_6_M_FRAME_ENABLE_OFFSET                         0x00000018
#define TX_FES_SETUP_6_M_FRAME_ENABLE_LSB                            22
#define TX_FES_SETUP_6_M_FRAME_ENABLE_MASK                           0x00400000
...
#define TX_FES_SETUP_6_RESERVED_6_LSB                                23
#define TX_FES_SETUP_6_RESERVED_6_MASK                               0xff800000

/* Description		TX_FES_SETUP_7_FES_TIME_160MHZ
			...
			available TXOP time
*/
#define TX_FES_SETUP_7_FES_TIME_160MHZ_OFFSET                        0x0000001c
#define TX_FES_SETUP_7_FES_TIME_160MHZ_LSB                           0
#define TX_FES_SETUP_7_FES_TIME_160MHZ_MASK                          0x0000ffff

/* Description		TX_FES_SETUP_7_RESERVED_7
			
			<legal 0>
*/
#define TX_FES_SETUP_7_RESERVED_7_OFFSET                             0x0000001c
#define TX_FES_SETUP_7_RESERVED_7_LSB                                16
#define TX_FES_SETUP_7_RESERVED_7_MASK                               0xffff0000
