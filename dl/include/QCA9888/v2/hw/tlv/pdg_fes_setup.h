...
//
//	Dword	Fields
//	0	transmit_fes_type[3:0], medium_prot_type[6:4], su_response_type[9:7], update_timestamp_32[10], update_timestamp_64[11], reserved_0_a[17:12], mprot_required_bw20[18], mprot_required_bw40[19], mprot_required_bw80[20], mprot_required_bw160[21], ppdu_allowed_bw20[22], ppdu_allowed_bw40[23], ppdu_allowed_bw80[24], ppdu_allowed_bw160[25], other_queues_more_data[26], bw_indication_enable[27], set_fc_pwr_mgt[28], reserved_0c[31:29]
...
//	11-12	struct tx_rate_setting tx_rate_ctr_mprot_bw160;
//	13-14	struct tx_rate_setting response_rate_mprot_bw20;
//	15-16	struct tx_rate_setting response_rate_mprot_bw40;
//	17-18	struct tx_rate_setting response_rate_mprot_bw80;
//	19-20	struct tx_rate_setting response_rate_mprot_bw160;
//
// ################ END SUMMARY #################

#define NUM_OF_DWORDS_PDG_FES_SETUP 21
...
struct pdg_fes_setup {
    volatile uint32_t transmit_fes_type               :  4, //[3:0]
                      ...
                      mprot_required_bw160            :  1, //[21]
                      ppdu_allowed_bw20               :  1, //[22]
                      ppdu_allowed_bw40               :  1, //[23]
                      ppdu_allowed_bw80               :  1, //[24]
                      ppdu_allowed_bw160              :  1, //[25]
                      other_queues_more_data          :  1, //[26]
                      bw_indication_enable            :  1, //[27]
                      set_fc_pwr_mgt                  :  1, //[28]
                      reserved_0c                     :  3; //[31:29]
    ...
    struct            tx_rate_setting                       tx_rate_ctr_mprot_bw160;
    ...
    struct            tx_rate_setting                       response_rate_mprot_bw160;
};
...
mprot_required_bw160
			...
			When set, Medium protection transmission is required for
			a 160 MHz bandwidth PPDU transmission. In case of MU
			transmissions, all the medium protection settings are coming
			from user0. <legal all>
...
struct tx_rate_setting tx_rate_ctr_mprot_bw160
			...
			Field only valid when Mprot_required_bw160 is set.
			
			Structure containing all the rate information for
			transmitting a medium protection frame at 160 MHz.
...
/* Description		PDG_FES_SETUP_0_MPROT_REQUIRED_BW160
			...
			from user0. <legal all>
*/
#define PDG_FES_SETUP_0_MPROT_REQUIRED_BW160_OFFSET                  0x00000000
#define PDG_FES_SETUP_0_MPROT_REQUIRED_BW160_LSB                     21
#define PDG_FES_SETUP_0_MPROT_REQUIRED_BW160_MASK                    0x00200000
...
#define PDG_FES_SETUP_0_PPDU_ALLOWED_BW20_LSB                        22
#define PDG_FES_SETUP_0_PPDU_ALLOWED_BW20_MASK                       0x00400000
...
#define PDG_FES_SETUP_0_PPDU_ALLOWED_BW40_LSB                        23
#define PDG_FES_SETUP_0_PPDU_ALLOWED_BW40_MASK                       0x00800000
...
#define PDG_FES_SETUP_0_PPDU_ALLOWED_BW80_LSB                        24
#define PDG_FES_SETUP_0_PPDU_ALLOWED_BW80_MASK                       0x01000000

/* Description		PDG_FES_SETUP_0_PPDU_ALLOWED_BW160
			
			When set, allow PPDU transmission with 80 MHz bandwidth.
			In case of MU transmissions, all the ppdu allowed bw
			settings are coming from user0 <legal all>
*/
#define PDG_FES_SETUP_0_PPDU_ALLOWED_BW160_OFFSET                    0x00000000
#define PDG_FES_SETUP_0_PPDU_ALLOWED_BW160_LSB                       25
#define PDG_FES_SETUP_0_PPDU_ALLOWED_BW160_MASK                      0x02000000
...
#define PDG_FES_SETUP_0_OTHER_QUEUES_MORE_DATA_LSB                   26
#define PDG_FES_SETUP_0_OTHER_QUEUES_MORE_DATA_MASK                  0x04000000
...
#define PDG_FES_SETUP_0_BW_INDICATION_ENABLE_LSB                     27
#define PDG_FES_SETUP_0_BW_INDICATION_ENABLE_MASK                    0x08000000
...
#define PDG_FES_SETUP_0_SET_FC_PWR_MGT_LSB                           28
#define PDG_FES_SETUP_0_SET_FC_PWR_MGT_MASK                          0x10000000
...
#define PDG_FES_SETUP_0_RESERVED_0C_LSB                              29
#define PDG_FES_SETUP_0_RESERVED_0C_MASK                             0xe0000000
...
#define PDG_FES_SETUP_11_TX_RATE_SETTING_TX_RATE_CTR_MPROT_BW160_OFFSET 0x0000002c
#define PDG_FES_SETUP_11_TX_RATE_SETTING_TX_RATE_CTR_MPROT_BW160_LSB 16
#define PDG_FES_SETUP_11_TX_RATE_SETTING_TX_RATE_CTR_MPROT_BW160_MASK 0xffffffff
#define PDG_FES_SETUP_12_TX_RATE_SETTING_TX_RATE_CTR_MPROT_BW160_OFFSET 0x00000030
#define PDG_FES_SETUP_12_TX_RATE_SETTING_TX_RATE_CTR_MPROT_BW160_LSB 16
#define PDG_FES_SETUP_12_TX_RATE_SETTING_TX_RATE_CTR_MPROT_BW160_MASK 0xffffffff
#define PDG_FES_SETUP_13_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW20_OFFSET 0x00000034
#define PDG_FES_SETUP_13_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW20_LSB 16
#define PDG_FES_SETUP_13_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW20_MASK 0xffffffff
#define PDG_FES_SETUP_14_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW20_OFFSET 0x00000038
#define PDG_FES_SETUP_14_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW20_LSB 16
#define PDG_FES_SETUP_14_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW20_MASK 0xffffffff
#define PDG_FES_SETUP_15_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW40_OFFSET 0x0000003c
#define PDG_FES_SETUP_15_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW40_LSB 16
#define PDG_FES_SETUP_15_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW40_MASK 0xffffffff
#define PDG_FES_SETUP_16_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW40_OFFSET 0x00000040
#define PDG_FES_SETUP_16_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW40_LSB 16
#define PDG_FES_SETUP_16_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW40_MASK 0xffffffff
#define PDG_FES_SETUP_17_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW80_OFFSET 0x00000044
#define PDG_FES_SETUP_17_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW80_LSB 16
#define PDG_FES_SETUP_17_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW80_MASK 0xffffffff
#define PDG_FES_SETUP_18_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW80_OFFSET 0x00000048
#define PDG_FES_SETUP_18_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW80_LSB 16
#define PDG_FES_SETUP_18_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW80_MASK 0xffffffff
#define PDG_FES_SETUP_19_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW160_OFFSET 0x0000004c
#define PDG_FES_SETUP_19_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW160_LSB 16
#define PDG_FES_SETUP_19_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW160_MASK 0xffffffff
#define PDG_FES_SETUP_20_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW160_OFFSET 0x00000050
#define PDG_FES_SETUP_20_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW160_LSB 16
#define PDG_FES_SETUP_20_TX_RATE_SETTING_RESPONSE_RATE_MPROT_BW160_MASK 0xffffffff
