...
struct l_sig_a l_sig_a_bw20
			...
			correspond to 20, 40,  80 or 160 MHz response frame
...
struct tx_service tx_service_bw20
			...
			field may correspond to 20, 40, 80 or 160 MHz response frame
			depending on bandwidth field in the PDG_RESPONSE.
...
duration_bw20
			...
			this field may correspond to 20, 40, 80 or 160 MHz response
