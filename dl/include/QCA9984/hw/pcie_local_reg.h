...
// 0x0 (RTC_STATE)
#define RTC_STATE_SLEEP_INIT_REG_LSB                                           14
#define RTC_STATE_SLEEP_INIT_REG_MSB                                           14
#define RTC_STATE_SLEEP_INIT_REG_MASK                                          0x4000
#define RTC_STATE_SLEEP_INIT_REG_GET(x)                                        (((x) & RTC_STATE_SLEEP_INIT_REG_MASK) >> RTC_STATE_SLEEP_INIT_REG_LSB)
#define RTC_STATE_SLEEP_INIT_REG_SET(x)                                        (((0 | (x)) << RTC_STATE_SLEEP_INIT_REG_LSB) & RTC_STATE_SLEEP_INIT_REG_MASK)
#define RTC_STATE_SLEEP_INIT_REG_RESET                                         0x0
...
#define RTC_STATE_RSTMASK                                                      0x7fff
...
// 0x24 (AHB_TIMEOUT_STATUS)
#define AHB_TIMEOUT_STATUS_H_TIMEOUT_LSB                                       31
#define AHB_TIMEOUT_STATUS_H_TIMEOUT_MSB                                       31
#define AHB_TIMEOUT_STATUS_H_TIMEOUT_MASK                                      0x80000000
#define AHB_TIMEOUT_STATUS_H_TIMEOUT_GET(x)                                    (((x) & AHB_TIMEOUT_STATUS_H_TIMEOUT_MASK) >> AHB_TIMEOUT_STATUS_H_TIMEOUT_LSB)
#define AHB_TIMEOUT_STATUS_H_TIMEOUT_SET(x)                                    (((0 | (x)) << AHB_TIMEOUT_STATUS_H_TIMEOUT_LSB) & AHB_TIMEOUT_STATUS_H_TIMEOUT_MASK)
#define AHB_TIMEOUT_STATUS_H_TIMEOUT_RESET                                     0x0
#define AHB_TIMEOUT_STATUS_H_WR_RD_LSB                                         30
#define AHB_TIMEOUT_STATUS_H_WR_RD_MSB                                         30
#define AHB_TIMEOUT_STATUS_H_WR_RD_MASK                                        0x40000000
#define AHB_TIMEOUT_STATUS_H_WR_RD_GET(x)                                      (((x) & AHB_TIMEOUT_STATUS_H_WR_RD_MASK) >> AHB_TIMEOUT_STATUS_H_WR_RD_LSB)
#define AHB_TIMEOUT_STATUS_H_WR_RD_SET(x)                                      (((0 | (x)) << AHB_TIMEOUT_STATUS_H_WR_RD_LSB) & AHB_TIMEOUT_STATUS_H_WR_RD_MASK)
#define AHB_TIMEOUT_STATUS_H_WR_RD_RESET                                       0x0
#define AHB_TIMEOUT_STATUS_HADDR_LSB                                           0
#define AHB_TIMEOUT_STATUS_HADDR_MSB                                           20
#define AHB_TIMEOUT_STATUS_HADDR_MASK                                          0x1fffff
#define AHB_TIMEOUT_STATUS_HADDR_GET(x)                                        (((x) & AHB_TIMEOUT_STATUS_HADDR_MASK) >> AHB_TIMEOUT_STATUS_HADDR_LSB)
#define AHB_TIMEOUT_STATUS_HADDR_SET(x)                                        (((0 | (x)) << AHB_TIMEOUT_STATUS_HADDR_LSB) & AHB_TIMEOUT_STATUS_HADDR_MASK)
#define AHB_TIMEOUT_STATUS_HADDR_RESET                                         0x0
#define AHB_TIMEOUT_STATUS_ADDRESS                                             (0x24 + __PCIE_LOCAL_REG_BASE_ADDRESS)
#define AHB_TIMEOUT_STATUS_RSTMASK                                             0xc01fffff
#define AHB_TIMEOUT_STATUS_RESET                                               0x0
