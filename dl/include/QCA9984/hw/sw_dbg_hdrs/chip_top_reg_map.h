...
struct agc_reg_map {
  ...
  volatile unsigned int pad__2;                   /*       0xcc - 0xd0       */
  volatile u_int32_t BB_agc_rtt_ctrl;             /*       0xd0 - 0xd4       */
  volatile unsigned int pad__3[0x27];             /*       0xd4 - 0x170      */
  volatile u_int32_t BB_rx_gain_nf_en;            /*      0x170 - 0x174      */
  volatile unsigned int pad__4[0x3];              /*      0x174 - 0x180      */
...
struct chn_reg_map {
  ...
  volatile unsigned int pad__1[0xf];              /*       0x44 - 0x80       */
  ...
  volatile unsigned int pad__2[0x4];              /*       0xac - 0xbc       */
  ...
  volatile unsigned int pad__3[0x2];              /*      0x120 - 0x128      */
  ...
  volatile unsigned int pad__4;                   /*      0x134 - 0x138      */
...
struct sm_reg_map {
  ...
  volatile u_int32_t BB_rx_notch_cntl_2;          /*       0xac - 0xb0       */
  volatile u_int32_t BB_rx_notch_cntl_3;          /*       0xb0 - 0xb4       */
  volatile u_int32_t BB_rx_notch_cntl_4;          /*       0xb4 - 0xb8       */
  volatile u_int32_t BB_rx_notch_cntl_5;          /*       0xb8 - 0xbc       */
  ...
  volatile unsigned int pad__6[0x5];              /*       0xec - 0x100      */
  ...
  volatile u_int32_t BB_rtt_location_sec80;       /*      0x1d8 - 0x1dc      */
  volatile u_int32_t BB_rtt_tx_phase;             /*      0x1dc - 0x1e0      */
  volatile unsigned int pad__7[0x4];              /*      0x1e0 - 0x1f0      */
  volatile u_int32_t BB_powertx_max_sub;          /*      0x1f0 - 0x1f4      */
  volatile unsigned int pad__8;                   /*      0x1f4 - 0x1f8      */
  ...
  volatile unsigned int pad__9;                   /*      0x234 - 0x238      */
  ...
  volatile unsigned int pad__11[0x3e];            /*      0x288 - 0x380      */
  ...
  volatile unsigned int pad__12[0x2e];            /*      0x38c - 0x444      */
  ...
  volatile unsigned int pad__13[0x6];             /*      0x458 - 0x470      */
  ...
  volatile unsigned int pad__14[0x5];             /*      0x498 - 0x4ac      */
  volatile u_int32_t BB_rxiqcal_status_b0;        /*      0x4ac - 0x4b0      */
  volatile unsigned int pad__15[0x8];             /*      0x4b0 - 0x4d0      */
  volatile u_int32_t BB_hsprd_train_cntl_0;       /*      0x4d0 - 0x4d4      */
  volatile unsigned int pad__16[0x6];             /*      0x4d4 - 0x4ec      */
  ...
  volatile unsigned int pad__17;                  /*      0x50c - 0x510      */
  ...
  volatile unsigned int pad__18[0x1a];            /*      0x558 - 0x5c0      */
  ...
  volatile unsigned int pad__19;                  /*      0x5d0 - 0x5d4      */
  volatile u_int32_t BB_phyonly_control;          /*      0x5d4 - 0x5d8      */
  volatile unsigned int pad__20;                  /*      0x5d8 - 0x5dc      */
...
struct chn1_reg_map {
  ...
  volatile unsigned int pad__6[0x4];              /*      0x15c - 0x16c      */
...
struct agc2_reg_map {
  ...
  volatile u_int32_t BB_cca_ext80_b2;             /*       0x24 - 0x28       */
  volatile unsigned int pad__2[0x56];             /*       0x28 - 0x180      */
...
struct chn2_reg_map {
  ...
  volatile unsigned int pad__6[0x4];              /*      0x15c - 0x16c      */
  volatile u_int32_t BB_spur_ctrl1_pri_b2;        /*      0x16c - 0x170      */
  volatile u_int32_t BB_spur_ctrl2_pri_b2;        /*      0x170 - 0x174      */
  volatile u_int32_t BB_spur_ctrl1_ext_b2;        /*      0x174 - 0x178      */
  volatile u_int32_t BB_spur_ctrl2_ext_b2;        /*      0x178 - 0x17c      */
  volatile u_int32_t BB_fdtg_ss3_data_b2;         /*      0x17c - 0x180      */
};
...
struct agc3_reg_map {
  ...
  volatile u_int32_t BB_cca_ext80_b3;             /*       0x24 - 0x28       */
  volatile unsigned int pad__2[0x56];             /*       0x28 - 0x180      */
...
struct chn3_reg_map {
  ...
  volatile unsigned int pad__6[0x4];              /*      0x15c - 0x16c      */
  volatile u_int32_t BB_spur_ctrl1_pri_b3;        /*      0x16c - 0x170      */
  volatile u_int32_t BB_spur_ctrl2_pri_b3;        /*      0x170 - 0x174      */
  volatile u_int32_t BB_spur_ctrl1_ext_b3;        /*      0x174 - 0x178      */
  volatile u_int32_t BB_spur_ctrl2_ext_b3;        /*      0x178 - 0x17c      */
  volatile u_int32_t BB_fdtg_ss3_data_b3;         /*      0x17c - 0x180      */
};
...
struct svd_reg_map {
  ...
  volatile unsigned int pad__4[0xe];              /*     0x1fc8 - 0x2000     */
  volatile u_int32_t BB_SVD_MEM3[242];            /*     0x2000 - 0x23c8     */
};
...
struct mrc_reg_map {
  ...
  volatile u_int32_t BB_delta_slope_coef_man_sgi; /*       0xa0 - 0xa4       */
  volatile u_int32_t BB_delta_slope_coef_man_ngi; /*       0xa4 - 0xa8       */
  volatile u_int32_t BB_cfo_corr_s_coef;          /*       0xa8 - 0xac       */
  volatile unsigned int pad__0[0x15];             /*       0xac - 0x100      */
...
struct bb_reg_map {
  ...
  struct chn_reg_map bb_chn_reg_map;              /*      0x400 - 0x584      */
  volatile unsigned int pad__0[0x1f];             /*      0x584 - 0x600      */
  ...
  struct chn1_reg_map bb_chn1_reg_map;            /*     0x1400 - 0x14f8     */
  volatile unsigned int pad__4[0x42];             /*     0x14f8 - 0x1600     */
  ...
  struct chn2_reg_map bb_chn2_reg_map;            /*     0x2400 - 0x24f8     */
  volatile unsigned int pad__7[0x42];             /*     0x24f8 - 0x2600     */
  ...
  struct chn3_reg_map bb_chn3_reg_map;            /*     0x3400 - 0x34f8     */
  volatile unsigned int pad__10[0x42];            /*     0x34f8 - 0x3600     */
  ...
  struct svd_reg_map bb_svd_reg_map;              /*     0x5000 - 0x73c8     */
  volatile unsigned int pad__15[0x30e];           /*     0x73c8 - 0x8000     */
  struct mrc_reg_map bb_mrc_reg_map;              /*     0x8000 - 0x8110     */
};
...
struct efuse_reg {
  ...
  volatile u_int32_t EFUSE_INTF2[512];            /*     0x1800 - 0x2000     */
  volatile u_int32_t EFUSE_INTF3[512];            /*     0x2000 - 0x2800     */
};
...
struct chip_top_reg_map {
  ...
  struct bb_reg_map bb_reg_map;                   /*    0x10000 - 0x18110    */
  volatile unsigned int pad__1[0x1fbc];           /*    0x18110 - 0x20000    */
  ...
  volatile unsigned int pad__29[0x3bd];           /*    0x8510c - 0x86000    */
  struct efuse_reg efuse_reg;                     /*    0x86000 - 0x88800    */
  volatile unsigned int pad__30[0x200];           /*    0x88800 - 0x89000    */
