...
// -----------------------------------------------------------------------------
// FILE         : tiered_chn_table_map_macro
...
/* macros for BlueprintGlobalNameSpace::chn_dc_notch_fd_cntl */
#ifndef __CHN_DC_NOTCH_FD_CNTL_MACRO__
#define __CHN_DC_NOTCH_FD_CNTL_MACRO__

/* macros for field enable_dc_notch_fd */
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD__SHIFT                       0
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD__WIDTH                       1
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD__MASK              0x00000001U
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD__READ(src) \
                    (u_int32_t)(src)\
                    & 0x00000001U
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD__WRITE(src) \
                    ((u_int32_t)(src)\
                    & 0x00000001U)
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | ((u_int32_t)(src) &\
                    0x00000001U)
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD__VERIFY(src) \
                    (!(((u_int32_t)(src)\
                    & ~0x00000001U)))
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (u_int32_t)(1)
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000001U) | (u_int32_t)(0)

/* macros for field enable_dc_notch_fd_vht_only */
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD_VHT_ONLY__SHIFT              1
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD_VHT_ONLY__WIDTH              1
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD_VHT_ONLY__MASK     0x00000002U
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD_VHT_ONLY__READ(src) \
                    (((u_int32_t)(src)\
                    & 0x00000002U) >> 1)
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD_VHT_ONLY__WRITE(src) \
                    (((u_int32_t)(src)\
                    << 1) & 0x00000002U)
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD_VHT_ONLY__MODIFY(dst, src) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | (((u_int32_t)(src) <<\
                    1) & 0x00000002U)
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD_VHT_ONLY__VERIFY(src) \
                    (!((((u_int32_t)(src)\
                    << 1) & ~0x00000002U)))
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD_VHT_ONLY__SET(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((u_int32_t)(1) << 1)
#define CHN_DC_NOTCH_FD_CNTL__ENABLE_DC_NOTCH_FD_VHT_ONLY__CLR(dst) \
                    (dst) = ((dst) &\
                    ~0x00000002U) | ((u_int32_t)(0) << 1)
#define CHN_DC_NOTCH_FD_CNTL__TYPE                                    u_int32_t
#define CHN_DC_NOTCH_FD_CNTL__READ                                  0x00000003U
#define CHN_DC_NOTCH_FD_CNTL__WRITE                                 0x00000003U

#endif /* __CHN_DC_NOTCH_FD_CNTL_MACRO__ */


/* macros for chn_table_map.BB_chn_dc_notch_fd_cntl */
#define INST_CHN_TABLE_MAP__BB_CHN_DC_NOTCH_FD_CNTL__NUM                      1
...
#define INST_CHN_TABLE_MAP__BB_CHN_DC_NOTCH_FD_01_MEM__NUM                  248
...
#define INST_CHN_TABLE_MAP__BB_CHN_DC_NOTCH_FD_23_MEM__NUM                  248
...
#define TIERED_CHN_TABLE_MAP__VERSION \
                    ...
                    /prj/qca/chips/cascade/1.0/santaclara/dev01/workspaces/aravindj/aj_cscd_view2/chips/cascade/1.0/src/chip_top/design/blueprint/srcs/chn_table_map.rdl"
