...
//-----------------------------------------------------------------------------
typedef enum {
  WIFI_LOCATION_FAC_LEGACY_STATUS_NOT_VALID          = 0,
  WIFI_LOCATION_FAC_LEGACY_STATUS_VALID              = 1
} rx_location_info__rtt_fac_legacy_status_e;         ///< rtt_fac_legacy_status Enum Type
typedef enum {
  WIFI_LOCATION_FAC_VHT_STATUS_NOT_VALID             = 0,
  WIFI_LOCATION_FAC_VHT_STATUS_VALID                 = 1
} rx_location_info__rtt_fac_vht_status_e;            ///< rtt_fac_vht_status Enum Type
typedef enum {
  WIFI_LOCATION_STRONGEST_CHAIN_IS_0                 = 0,
  WIFI_LOCATION_STRONGEST_CHAIN_IS_1                 = 1,
  WIFI_LOCATION_STRONGEST_CHAIN_IS_2                 = 2,
  WIFI_LOCATION_STRONGEST_CHAIN_IS_3                 = 3
} rx_location_info__rtt_strongest_chain_e;           ///< rtt_strongest_chain Enum Type
typedef enum {
  WIFI_LOCATION_CFR_DUMP_NOT_VALID                   = 0,
  WIFI_LOCATION_CFR_DUMP_VALID                       = 1
} rx_location_info__rtt_cfr_status_e;                ///< rtt_cfr_status Enum Type
typedef enum {
  WIFI_LOCATION_CIR_DUMP_NOT_VALID                   = 0,
  WIFI_LOCATION_CIR_DUMP_VALID                       = 1
} rx_location_info__rtt_cir_status_e;                ///< rtt_cir_status Enum Type
typedef enum {
  WIFI_LOCATION_PREAMBLE_TYPE_LEGACY                 = 0,
  WIFI_LOCATION_PREAMBLE_TYPE_B                      = 1,
  WIFI_LOCATION_PREAMBLE_TYPE_HT                     = 2,
  WIFI_LOCATION_PREAMBLE_TYPE_VHT                    = 3
} rx_location_info__rtt_preamble_type_e;             ///< rtt_preamble_type Enum Type
typedef enum {
  WIFI_LOCATION_LEGACY                               = 0,
  WIFI_LOCATION_PKT_BW_20MHZ                         = 1,
  WIFI_LOCATION_PKT_BW_40MHZ                         = 2,
  WIFI_LOCATION_PKT_BW_80MHZ                         = 3
} rx_location_info__pkt_bw_e;                        ///< pkt_bw Enum Type
typedef enum {
  WIFI_LOCATION_NORMAL_GI                            = 0,
  WIFI_LOCATION_SHORT_GI                             = 1
} rx_location_info__rtt_gi_type_e;                   ///< rtt_gi_type Enum Type
typedef enum {
  WIFI_LOCATION_PBD_LEG_BW_20MHZ                     = 0,
  WIFI_LOCATION_PBD_LEG_BW_40MHZ                     = 1,
  WIFI_LOCATION_PBD_LEG_BW_80MHZ                     = 2,
  WIFI_LOCATION_PBD_LEG_BW_160MHZ                    = 3
} rx_location_info__rtt_pbd_leg_bw_e;                ///< rtt_pbd_leg_bw Enum Type
typedef enum {
  WIFI_RX_LOCATION_INFO_IS_NOT_VALID                 = 0,
  WIFI_RX_LOCATION_INFO_IS_VALID                     = 1
} rx_location_info__rx_location_info_valid_e;        ///< rx_location_info_valid Enum Type
