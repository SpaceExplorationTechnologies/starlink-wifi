...
/* Bitmap for hi_skip_clock_init */
#define HI_SKIP_CLOCK_INIT_SKIP_PLL_CONFIG					0x01	/* skips Pll configuration */
#define HI_SKIP_CLOCK_INIT_SKIP_OTP_PLL_CONFIG_OVERRIDE		0x02	/* skips Pll configuration */
...
#define QCA9984_HOST_INTEREST_ITEM_ADDRESS(item) \
    (A_UINT32)((size_t)&((((struct host_interest_s *)(QCA9984_HOST_INTEREST_ADDRESS))->item)))

#define IPQ4019_HOST_INTEREST_ITEM_ADDRESS(item) \
    (A_UINT32)((size_t)&((((struct host_interest_s *)(IPQ4019_HOST_INTEREST_ADDRESS))->item)))

#define QCA9888_HOST_INTEREST_ITEM_ADDRESS(item) \
    (A_UINT32)((size_t)&((((struct host_interest_s *)(QCA9888_HOST_INTEREST_ADDRESS))->item)))
...
#define QCA9984_VTOP(vaddr) (vaddr)
#define IPQ4019_VTOP(vaddr) (vaddr)
#define QCA9888_VTOP(vaddr) (vaddr)
#define TARG_VTOP(TargetType, vaddr) \
        ...
        (((TargetType) == TARGET_TYPE_QCA9984) ? QCA9984_VTOP(vaddr) : \
        (((TargetType) == TARGET_TYPE_IPQ4019) ? IPQ4019_VTOP(vaddr) : \
        (((TargetType) == TARGET_TYPE_QCA9888) ? QCA9888_VTOP(vaddr) : \
         0))))))))))
...
#define HOST_INTEREST_ITEM_ADDRESS(TargetType, item) \
        ...
        (((TargetType) == TARGET_TYPE_QCA9984) ? QCA9984_HOST_INTEREST_ITEM_ADDRESS(item) : \
        (((TargetType) == TARGET_TYPE_IPQ4019) ? IPQ4019_HOST_INTEREST_ITEM_ADDRESS(item) : \
        (((TargetType) == TARGET_TYPE_QCA9888) ? QCA9888_HOST_INTEREST_ITEM_ADDRESS(item) : \
         0))))))))))
...
#define QCA9984_FETCH_TARG_REGS_COUNT 64
#define QCA9888_FETCH_TARG_REGS_COUNT 64
#define IPQ4019_FETCH_TARG_REGS_COUNT 64
