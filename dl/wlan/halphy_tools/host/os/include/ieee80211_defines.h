...
typedef enum _ieee80211_param {
    ...
    IEEE80211_VAP_TX_ENCAP_TYPE,  /* Used to set the Tx encapsulation mode of the VAP - RAW/NWIFI/802.3 */
    IEEE80211_VAP_RX_DECAP_MODE,  /* Used to set the Rx encapsulation mode of the VAP - RAW/NWIFI/802.3 */
