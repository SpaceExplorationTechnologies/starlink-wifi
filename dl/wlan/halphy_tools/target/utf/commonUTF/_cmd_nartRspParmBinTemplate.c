//This is an auto-generated file, from the given header file ../../../../../../../include/systemtools/common/cmdNartGenericRspParms.h //for parsing the tx cmd parms in the binary stream
