//This is an auto-generated file, from the given header file /trees/kumarpra/p4_1/sw/branches/olca/include/systemtools/common/cmdPmParms.h //for parsing the tx cmd parms in the binary stream
