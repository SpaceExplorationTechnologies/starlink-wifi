//This is an auto-generated file, from the given header file ../../../../../../../include/systemtools/common/cmdNartGenericCmdParms.h //for parsing the tx cmd parms in the binary stream
